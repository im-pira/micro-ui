...
export default function MusicPlayer() {
    ...
    const artwork =
        currentSong?.artworkUrl100.replace("100x100", "1200x1200") ?? "";

    const lyricTime = currentTime + lyricsOffset;

    const activeLyricIndex = lyrics.reduce(
        (last, line, index) =>
            lyricTime >= line.time ? index : last,
        -1
    );
        ...
        const loadLyrics = async () => {
            ...
            try {
                const cleanTitle = currentSong.trackName
                    ...
                    .replace(/\[[^\]]*\]/g, "")
                    .replace(
                        /-\s*(slowed|sped up|reverb|remix|cover).*$/i,
                        ""
                    )
                    .trim();
                ...
                for (const search of searches) {
                    ...
                    const data =
                        (await response.json()) as LyricsResult[];
            ...
            <div className="w-full max-w-[900px]">
                ...
                <form onSubmit={searchSongs} className="mb-4">
                    <div className="flex h-12 items-center gap-3 border-b border-white/10 px-1 transition-colors duration-300 focus-within:border-white/30">
                        <svg
                            viewBox="0 0 24 24"
                            className="size-[18px] shrink-0 fill-none stroke-white/35 stroke-[1.8]"
                        >
                    ...
                    <section className="relative min-h-[540px] overflow-hidden bg-black">
                        ...
                        <div className="absolute inset-x-0 top-0 flex items-center justify-end gap-2 p-4">
                            <button
                                ...
                                className="grid size-10 place-items-center rounded-full bg-black/35 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-black/55 active:scale-95 focus:outline-none"
                            >
                                <svg
                                    viewBox="0 0 24 24"
                                    className={`size-[18px] stroke-2 transition-all duration-300 ${
                                        liked
                        ...
                        <div className="absolute inset-x-0 bottom-0 p-6">
                            ...
                            <div className="relative mt-5 h-16">
                                ...
                                <button
                                    ...
                                    className={`absolute left-0 top-1/2 grid size-9 -translate-y-1/2 place-items-center transition-colors duration-300 focus:outline-none ${
                                        shuffle
                                            ? "text-white"
                                ...
                                <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center gap-5">
                                    <button
                                        ...
                                        className="grid size-10 place-items-center text-white/45 transition-all duration-300 hover:scale-110 hover:text-white active:scale-90 focus:outline-none"
                                    >
                                        <svg
                                            viewBox="0 0 24 24"
                                    ...
                                    <button
                                        ...
                                        className="group relative grid size-[72px] place-items-center rounded-full focus:outline-none"
                                    >
                                        <span
                                            className={`absolute inset-0 rounded-full border border-white/25 bg-gradient-to-br from-zinc-100 via-zinc-300 to-zinc-500 shadow-[inset_0_2px_3px_rgba(255,255,255,0.9),inset_0_-3px_5px_rgba(0,0,0,0.28),0_5px_16px_rgba(0,0,0,0.35)] ${
                                                isPlaying
                                        ...
                                        >
                                            {Array.from({
                                                ...
                                                <span
                                                    key={i}
                                                    className="absolute left-1/2 top-1/2 size-[2px] rounded-full bg-black/35"
                                                    style={{
                                ...
                                <div className="absolute right-0 top-1/2 flex w-[190px] -translate-y-1/2 items-center justify-end gap-1">
                                        ...
                                        <div className="max-w-0 overflow-hidden opacity-0 transition-[max-width,opacity] duration-500 ease-out group-hover:max-w-[122px] group-hover:opacity-100">
                                            <div className="mr-1.5 flex h-7 items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.07] px-2 backdrop-blur-lg">
                                                ...
                                                <div className="relative h-4 w-14">
                                                    ...
                                                    <div
                                                        className="absolute left-0 top-1/2 h-px -translate-y-1/2 bg-white/75"
                                                        style={{
                                                            width: `${volume * 100}%`,
                                                        }}
                                                    />
                                    ...
                                    <button
                                        ...
                                        className={`grid size-9 shrink-0 place-items-center transition-colors duration-300 focus:outline-none ${
                                            repeat
                                                ? "text-white"
                                                : "text-white/30 hover:text-white"
                                        }`}
                                    ...
                                    (song, index) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`flex w-full items-center gap-3 rounded-xl p-2 text-left transition-all duration-300 focus:outline-none ${
                                                    active
                                                        ? "bg-gradient-to-b from-white/[0.10] to-white/[0.045] shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_4px_14px_rgba(0,0,0,0.25)]"
                    ...
                    <div className="mb-3 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            {lyrics.length > 0 && (
                                <div className="flex items-center gap-2 text-[10px] text-white/30">
                                    <button
                                        ...
                                        className="transition hover:text-white focus:outline-none"
                                    >
                                        −5s
                                    </button>
                            ...
                            <div className="flex items-center gap-1.5">
                                {isPlaying &&
                                    lyrics.length > 0 && (
                                        <span className="size-1 animate-pulse rounded-full bg-white/50" />
                                    )}
