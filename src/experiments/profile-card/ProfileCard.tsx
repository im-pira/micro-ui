export default function ProfileCard() {
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-[#101010]">
            <div className="w-[360px] rounded-[36px] bg-[linear-gradient(180deg,#070707_0%,#000_55%,#050505_100%)] p-[14px] border border-white/[0.035] shadow-[inset_0_1px_0_rgba(255,255,255,0.04),inset_0_-1px_0_rgba(255,255,255,0.015),0_18px_35px_rgba(0,0,0,0.35),0_45px_90px_-28px_rgba(0,0,0,0.75)]">
                <div className="relative rounded-[28px] p-[1px] overflow-hidden bg-white/10">
                    ...
                    <div className="relative overflow-hidden rounded-[27px]">
                        <img src="/profile-card/iron.png" alt="profile" className="h-[360px] w-full object-cover" />
                ...
                <div className="flex items-center justify-between px-2 pt-4 pb-1">
                    <div className="flex items-center gap-2.5">
                        <div className="relative h-10 w-10">
                            ...
                            <span className="absolute right-0.5 bottom-0 h-[8px] w-[8px] rounded-full border-[0.5px] border-black bg-[#11ad50]" />
                        </div>

                        <div className="leading-tight">
                            <p className="text-[14px] font-medium tracking-[-0.2px] text-white/90">@drake</p>
                            <p className="mt-1 text-[11px] text-white/35">2m ago</p>
                        </div>
                    </div>
